-- Judul: Mengidentifikasi Top 5 Produk Berdasarkan Frekuensi dan Total Nilai Transaksi Tahun 2022
...
--             dari produk tersebut selama tahun 2022.

SELECT
    product_name,
    COUNT(transaction_id) AS jumlah_transaksi_2022, -- Menghitung total jumlah transaksi untuk setiap produk pada tahun 2022.
    ROUND(SUM(nett_sales), 2) AS total_nilai_transaksi_2022 -- Menghitung total nilai transaksi (nett sales) untuk setiap produk pada tahun 2022, dibulatkan hingga 2 desimal.
FROM
...
ORDER BY
    jumlah_transaksi_2022 DESC, -- Mengurutkan hasil berdasarkan jumlah transaksi secara menurun (produk dengan transaksi terbanyak di atas).
