-- Judul: Mengidentifikasi Nama Cabang Berdasarkan Frekuensi dan Total Nilai Transaksi (2020-2023)
...
--             jumlah transaksi yang terjadi di setiap cabang dan total nilai transaksi (nett sales)
...
SELECT
    ...
    ROUND(SUM(nett_sales), 2) AS total_nilai_transaksi -- Menghitung total nilai transaksi (nett sales) untuk setiap nama cabang, dibulatkan hingga 2 desimal.
FROM
