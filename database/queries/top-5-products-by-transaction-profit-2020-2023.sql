-- Judul: Mengidentifikasi Top 5 Produk Berdasarkan Frekuensi Transaksi dan Total Nilai Profit (2020-2023)
...
--             jumlah transaksi di mana produk tersebut terjual dan total nilai profit (nett profit)
--             yang dihasilkan oleh produk tersebut selama rentang waktu tahun 2020 hingga 2023.

SELECT
    product_name,
    COUNT(transaction_id) AS jumlah_transaksi, -- Menghitung total jumlah transaksi untuk setiap produk.
    ROUND(SUM(nett_profit), 2) AS total_nilai_profit -- Menghitung total nilai profit (nett profit) untuk setiap produk, dibulatkan hingga 2 desimal.
FROM
